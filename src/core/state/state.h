...
constexpr u32 FORMAT_VERSION = 4;   // 2: HEAD carries bios_id + firmware_id; 3: DSi (two more scheduler events, 16 MB main RAM, DSI chunk); 4: the DSi SD/MMC host (one more scheduler event)
