...
const char* const count_names[] = {"3d polygon lines", "3d span pixels", "3d resolved pixels",
  ...
  "2d lazy frames", "2d vram trap hits", "2d lag frames", "2d lag: trapped stores", "2d lag: stores that joined a line", "2d lag: frames that hit the trap limit", "2d lag: lines left in flight",
